...
public class DropDownDemo extends CommonMethods{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		// by value attribute value
		select.selectByValue("Friday");
		
		//WE CAN GET THE OPTIONS OF THE DROP DOWN AND MAKE A LIST, GET THE SIZE
		...
		Thread.sleep(2000);
		select2.deselectByIndex(3);// we  can only deselect options in multiselect dropdown 
